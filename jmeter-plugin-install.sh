...
java -cp /opt/apache/apache-jmeter-${JMETER_VERSION}/lib/ext/jmeter-plugins-manager-${JMETER_PLUGIN_WEBDRIVER_VERSION}.jar org.jmeterplugins.repository.PluginManagerCMDInstaller
